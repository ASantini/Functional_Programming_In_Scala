...
object patmatWkst {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(82); 
  ...
  val testfreqs = Huffman.makeOrderedLeafList(testTimes);System.out.println("""testfreqs  : List[patmat.Huffman.Leaf] = """ + $show(testfreqs ));$skip(421); 
      ...
      };System.out.println("""insertSort: (acc: List[patmat.Huffman.Leaf], remain: List[patmat.Huffman.Leaf], current: (Char, Int))List[patmat.Huffman.Leaf]""");$skip(225); 
      ...
      };System.out.println("""createList: (remaining: List[(Char, Int)], acc: List[patmat.Huffman.Leaf])List[patmat.Huffman.Leaf]""");$skip(61); 
  ...
  var testSort5 = insertSort(List(), testSort4, ('c', 3));System.out.println("""testSort5  : List[patmat.Huffman.Leaf] = """ + $show(testSort5 ));$skip(166); val res$0 = 
                                                 
                                                
    createList(List(('t', 2), ('e', 1), ('x', 3)), List()).reverse;System.out.println("""res0: List[patmat.Huffman.Leaf] = """ + $show(res$0));$skip(69); val res$1 = 
  
  Huffman.makeOrderedLeafList(List(('t', 2), ('e', 1), ('x', 3)));System.out.println("""res1: List[patmat.Huffman.Leaf] = """ + $show(res$1))}
